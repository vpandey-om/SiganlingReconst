...
def highConservedNet():
    ...
    slist=pickle.load(open('/Users/vikashpandey/Documents/Scripts/pcst_fast-master/examples/high_consistent_cluster.pickle'))
...
if "__main__==__name__":
    ...
    fout=open('/Users/vikashpandey/Documents/Scripts/pcst_fast-master/examples/high_consistent_nodes_edge_list_cytoscape.pickle','w')
